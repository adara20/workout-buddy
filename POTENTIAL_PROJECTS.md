...
## 1. Visual Progression Charts ("The Gains View")
**Problem:** Currently, progress is only visible as static PR and Working Weight numbers.
**Solution:** Add a high-performance SVG line chart in the `PillarDetailOverlay`.
- **Details:** Visualize PR and Working Weight trends over time.
- **Value:** Provides visual feedback and motivation for long-term consistency.

## 2. Auto-Progression Logic ("Level Up")
